...
class DatabricksApp:
  ...
  def mount_fastapi_app(self, fastapi_app):
    self._fastapi_app.mount("/fastapi", fastapi_app)
    self.display_url(self.get_fastapi_url())
  ...
  def get_fastapi_url(self):
    return f'<a href="{self._ps.proxy_url}fastapi">Click to go to FastAPI App!</a>'
